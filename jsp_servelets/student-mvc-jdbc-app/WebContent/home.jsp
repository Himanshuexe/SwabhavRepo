  ...
  %>
	...
	<table class="table table-striped">
		...
		<%
			...
			+ student.getLastName() + "</td><td>" + student.getCgpa() + "</td><td><a href=" + " \" editstudent?rollNo="
			+ student.getRollNo() + "\">edit</a></td><td><a class=" + "\"delete\"" + " href="
			+ "\"deletestudent?rollNo=" + student.getRollNo() + "\">delete</a></td></tr>");
		}
		%>
	</table><%
	for(int i=1; i<=  )
